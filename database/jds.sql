...
INSERT INTO `department` VALUES (2,'FRONT OFFICE'),(3,'CAFE'),(4,'SOUVENIR'),(5,'FOOD KIOSK');
...
CREATE TABLE `reservation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `res_id` varchar(100) DEFAULT NULL,
  `res_fullname` varchar(100) DEFAULT NULL,
  `res_address` text,
  `res_contactno` varchar(45) DEFAULT NULL,
  `res_email` varchar(45) DEFAULT NULL,
  `res_nationality` varchar(45) DEFAULT NULL,
  `res_date_arrive` date DEFAULT NULL,
  `res_time_arrive` time DEFAULT NULL,
  `res_date_depart` date DEFAULT NULL,
  `res_time_depart` time DEFAULT NULL,
  `res_book_date` date DEFAULT NULL,
  `res_book_time` time DEFAULT NULL,
  `res_no_nights` int DEFAULT NULL,
...
CREATE TABLE `reservation_details` (
  `id` int NOT NULL AUTO_INCREMENT,
  `res_id` varchar(100) DEFAULT NULL,
  `res_amount_due` double DEFAULT NULL,
  `res_amount_paid` double DEFAULT NULL,
  `datearray` date DEFAULT NULL,
  `timearray` time DEFAULT NULL,
...
CREATE TABLE `room` (
  ...
  `room_color` varchar(100) DEFAULT NULL,
  `room_inclusion` text,
  `room_excess` double DEFAULT NULL,
  `room_fo_status` varchar(45) DEFAULT NULL,
  `rom_hk_status` varchar(45) DEFAULT NULL,
  `datearray` date DEFAULT NULL,
  `timearray` time DEFAULT NULL,
  `fullname` varchar(100) DEFAULT NULL,
  `room_image` longblob,
...
CREATE TABLE `settings` (
  ...
  `company_contactno` varchar(45) DEFAULT NULL,
  `datearray` date DEFAULT NULL,
  `timearrat` time DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-12 23:07:50
