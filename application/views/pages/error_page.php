                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4">
                                <div class="col-12 text-center mb-1 mb-lg-5">
                                    <img src="<?=base_url('design/assets/images/not_found.svg');?>" class="w240 mb-4" alt="" />
                                ...
                                <div class="col-12 text-center">
                                    <a href="<?=base_url();?>" title="" class="btn btn-lg btn-block btn-light lift text-uppercase">Back to Home</a>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
