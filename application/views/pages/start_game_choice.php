...
<div class=" row">
    ...
    <div class="col-12">
        <div class="well top-block">
            ...
            <center>
            <table width="70%" border="0" style="font-size:20px;">
                <form action="<?=base_url('submit_answer');?>" method="POST" id="quizForm">
                    ...
                    <input type="radio" name="youranswer" checked value="-" id="answer" style="display:none;">
                            <tr>
                                <td colspan="2"><h2><?=$games['game_question'];?></h2></td>
                            </tr>
                            <tr>
                                <td width="10%">&nbsp;</td>
                                <td><input type="radio" name="youranswer" value="<?=$games['choice1'];?>"> <?=$games['choice1'];?></td>
                            </tr>
                            <tr>
                                <td width="10%">&nbsp;</td>
                                <td><input type="radio" name="youranswer" value="<?=$games['choice2'];?>"> <?=$games['choice2'];?></td>
                            </tr>
                            <tr>
                                <td width="10%">&nbsp;</td>
                                <td><input type="radio" name="youranswer" value="<?=$games['choice3'];?>"> <?=$games['choice3'];?></td>
                            </tr>
                            <tr>
                                <td width="10%">&nbsp;</td>
                                <td><input type="radio" name="youanswer" value="<?=$games['choice4'];?>"> <?=$games['choice4'];?></td>
                            </tr>
                            <tr>
                                <td></td><td><input type="submit" class="btn btn-primary" value="Submit" style="width:100px; height:50px; font-size:18px;"></td>
                            </tr>
                </form>
            </table>
            </center>
